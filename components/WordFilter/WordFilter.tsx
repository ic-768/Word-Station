...
const WordFilter = ({
  ...
  <div className="flex flex-col width-max">
    ...
    <div className="flex items-center bg-white transition gap-1 rounded-md focus-within:ring focus-within:ring-indigo-500">
      <input
        onChange={onChangeFilter}
        className="px-4 py-2 text-black bg-transparent appearance-none focus:outline-none leading-5"
      />
